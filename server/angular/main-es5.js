(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.handleInput = function (e) {
                ...
                AppComponent.prototype.handleSubmit = function (e) {
                    ...
                    fetch("/api/name/" + this.state.queryString)
                        ...
                        .then(function (resp) { return _this.state.queryResults = resp; });
                };
                return AppComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CategorySearchComponent = /** @class */ (function () {
                function CategorySearchComponent(route) {
                    this.route = route;
                    this.details = {};
                }
                CategorySearchComponent.prototype.getGameDetails = function () {
                    var _this = this;
                    var id = this.route.snapshot.paramMap.get('id');
                    fetch("/api/game/" + id)
                        .then(function (resp) { return resp.json(); })
                        .then(function (resp) { return _this.details = resp; });
                };
            ...
            CategorySearchComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Comment = /** @class */ (function () {
                function Comment(username, text, gameid) {
                }
                return Comment;
            }());
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OnegameComponent = /** @class */ (function () {
                function OnegameComponent(route) {
                    this.route = route;
                    this.id = 0;
                    this.results = {};
                ...
                OnegameComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                OnegameComponent.prototype.findDetailsById = function (id) {
                    var _this = this;
                    fetch("/api/category/id/" + id)
                        .then(function (resp) { return resp.json(); })
                        .then(function (resp) { return _this.results = resp; });
                };
                OnegameComponent.prototype.fetchComments = function (id) {
                    var _this = this;
                    fetch("/api/comments/" + id)
                        .then(function (resp) { return resp.json(); })
                        .then(function (resp) { return _this.comments = resp; });
                };
                OnegameComponent.prototype.addComment = function (form) {
                    var _this = this;
                    var comment = Object.assign({}, this.model, { gameid: this.id });
                    fetch('/api/comment/new', {
                        ...
                        .then(function (resp) { return _this.fetchComments(_this.id); });
                };
                return OnegameComponent;
            }());
            OnegameComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Query = /** @class */ (function () {
                function Query(searchString, type) {
                }
                return Query;
            }());
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchFormComponent = /** @class */ (function () {
                ...
                SearchFormComponent.prototype.searchGames = function (form) {
                    var searchString = form.controls['searchString'].value;
                    var type = form.controls['type'].value;
                    switch (type) {
                        case "name":
                ...
                SearchFormComponent.prototype.findGamesByName = function (name) {
                    var _this = this;
                    fetch("/api/name/" + name)
                        .then(function (resp) { return resp.json(); })
                        .then(function (resp) { return _this.results = resp; })
                        .then(function (resp) { return console.log(_this.results); });
                };
                SearchFormComponent.prototype.findGamesByCategory = function (category) {
                    var _this = this;
                ...
                SearchFormComponent.prototype.findDetailsById = function (id) {
                    var _this = this;
                    fetch("/api/game/" + id)
                        .then(function (resp) { return resp.json(); })
                        .then(function (resp) { return _this.results = resp; })
